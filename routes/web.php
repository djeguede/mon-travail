...
Route::get('/employer/{employer}', [AuthorControllerController::class, 'employer'])->name('account.employer');
...
Route::middleware('auth')->prefix('account')->group(function(){
    ...
    Route::group(['middleware' => ['role:admin']], function(){
        Route::get('dashboard', [Adminontroller::class, 'dashboard'])->name('account.dashboard');
        ...
        Route::post('category', [CompanyCategorytController::class, 'store'])->name('category.store');
    ...
    Route::group(['middleware' => ['']], function(){
        ...
        Route::get('job-application', [JobApplicationController::class, 'destroy'])->name('jobApplication.destroy');
